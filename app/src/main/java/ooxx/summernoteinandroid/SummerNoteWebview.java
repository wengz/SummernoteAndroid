package ooxx.summernoteinandroid;
...
public class SummerNoteWebview extends WebView {
    ...
    public SummerNoteWebview(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        enable_summernote();
    }

    public SummerNoteWebview(Context context, AttributeSet attrs, int defStyle) {
